0. Refer to the "Readings" assignment of the course website on ci/cd & testing on how to create a fully funcional ci/cd workflow. You can also access https://github.com/jhu-st/ci-helloworld/ for the complete project.
